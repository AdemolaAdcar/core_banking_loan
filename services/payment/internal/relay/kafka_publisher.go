...
// consumer of payment.disbursement.confirmed/payment.disbursement.failed/
// payment.inbound.received elsewhere in this system is already expected
// to be idempotent (same assumption internal/outbox's package doc
// comment states) — this package does not invent a new delivery
// guarantee the rest of the platform doesn't already rely on.
package relay
...
// message (every payment.* event type shares this one Writer), and
