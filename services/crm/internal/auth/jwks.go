...
// OAuth2 authorization server (crm.yaml's serviceAuth.tokenUrl) issues.
// Scope is the standard OAuth2 space-delimited "scope" claim;
...
// would make every crm.yaml call depend on the auth server's
